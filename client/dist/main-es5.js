...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsReceiptReceiptComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_order_order_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _components_products_products_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/products/products.component */
    "./src/app/components/products/products.component.ts");
    /* harmony import */


    var _components_receipt_receipt_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/receipt/receipt.component */
    ...
    var routes = [{
      ...
      path: "receipt",
      component: _components_receipt_receipt_component__WEBPACK_IMPORTED_MODULE_8__["ReceiptComponent"]
    }, {
      path: "admin",
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_order_order_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/order/order.component */
    "./src/app/components/order/order.component.ts");
    /* harmony import */
    ...
    var _highlight_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./highlight.pipe */
    "./src/app/highlight.pipe.ts");
    /* harmony import */


    var ngx_text_highlight__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ngx-text-highlight */
    "./node_modules/ngx-text-highlight/ngx-text-highlight.umd.js");
    /* harmony import */


    var ngx_text_highlight__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(ngx_text_highlight__WEBPACK_IMPORTED_MODULE_15__);
    /* harmony import */


    var _components_receipt_receipt_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./components/receipt/receipt.component */
    "./src/app/components/receipt/receipt.component.ts");
    /* harmony import */


    var ngx_filesaver__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ngx-filesaver */
    "./node_modules/ngx-filesaver/fesm2015/ngx-filesaver.js");
    /* harmony import */


    var _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./components/admin/admin.component */
    "./src/app/components/admin/admin.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_components_layout_layout_component__WEBPACK_IMPORTED_MODULE_5__["LayoutComponent"], _components_register_register_component__WEBPACK_IMPORTED_MODULE_6__["RegisterComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"], _components_products_products_component__WEBPACK_IMPORTED_MODULE_9__["ProductsComponent"], _components_order_order_component__WEBPACK_IMPORTED_MODULE_12__["OrderComponent"], _components_header_header_component__WEBPACK_IMPORTED_MODULE_13__["HeaderComponent"], _highlight_pipe__WEBPACK_IMPORTED_MODULE_14__["HighlightPipe"], _components_receipt_receipt_component__WEBPACK_IMPORTED_MODULE_16__["ReceiptComponent"], _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_18__["AdminComponent"]],
      imports: [ngx_filesaver__WEBPACK_IMPORTED_MODULE_17__["FileSaverModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModule"], _angular_common__WEBPACK_IMPORTED_MODULE_10__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], ngx_text_highlight__WEBPACK_IMPORTED_MODULE_15__["NgHighlightModule"]],
  ...
  function srcAppComponentsAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_categories_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var AdminComponent = /*#__PURE__*/function () {
      function AdminComponent(productService, categoryService, http) {
      ...
      _createClass(AdminComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productService.getAllProducts().subscribe(function (res) {
            _this.allProducts = JSON.parse(JSON.stringify(res));
          }, function (err) {
            return alert(err.error);
          });
          this.categoryService.getAllCategories().subscribe(function (res) {
            _this.category = JSON.parse(JSON.stringify(res));
          });
        }
      }, {
        key: "productsByCategory",
        value: function productsByCategory(c) {
          this.viewMode = c.categoryName;

          switch (c.id) {
            case '5ef86303d61ec32ac0e71960':
              this.productsByCategoryArr = this.allProducts.filter(function (i) {
                return i.categoryId === "5ef86303d61ec32ac0e71960";
              });
              break;

            case '5ef86351d61ec32ac0e71986':
              this.productsByCategoryArr = this.allProducts.filter(function (i) {
                return i.categoryId === "5ef86351d61ec32ac0e71986";
              });
              break;

            case '5ef8636cd61ec32ac0e71990':
              this.productsByCategoryArr = this.allProducts.filter(function (i) {
                return i.categoryId === "5ef8636cd61ec32ac0e71990";
              });
              break;

            case '5ef8638fd61ec32ac0e71996':
              this.productsByCategoryArr = this.allProducts.filter(function (i) {
                return i.categoryId === "5ef8638fd61ec32ac0e71996";
              });
              break;
        ...
        value: function searchProduct(e) {
          var target = e.target;
          this.productsByCategoryArr = this.allProducts.filter(function (el) {
            return el.productName.toLowerCase().indexOf(target.value.toLowerCase()) !== -1;
          });
          this.viewMode = 'search';
        }
      }, {
        key: "chooseProduct",
        value: function chooseProduct(product) {
        ...
        value: function addNew() {
          ...
          formData.append('image', this.imageFile); // this.http.post('url' , formData).subscribe((res)=>{
          //    /* if all is ok */
          ...
          fetch("http://localhost:3000/api/products/add-product", options).then(function () {
    ...
    AdminComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      selector: 'app-admin',
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(myUsersService, formBuilder) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login(username, password) {
          ...
          this.myUsersService.postLoggedInUser(credentials).subscribe(function (loggedInUser) {
            return localStorage.setItem("user", JSON.stringify(loggedInUser));
          }, function (err) {
            return alert(err.message);
          });
        }
      ...
      _createClass(OrderComponent, [{
        ...
        value: function ngOnInit() {
          if (JSON.parse(localStorage.getItem("currentCart")).length > 0) {
            ...
            (_this$cartArr = this.cartArr).push.apply(_this$cartArr, _toConsumableArray(JSON.parse(localStorage.getItem("currentCart"))));

            this.total = this.cartArr.reduce(function (accum, item) {
        ...
        value: function searchProduct(e) {
          ...
          var target = e.target;
          this.searchResult = this.cartArr.filter(function (el) {
            _this2.startIndex = el.productName.toLowerCase().indexOf(target.value.toLowerCase());

            if (_this2.startIndex != -1) {
              _this2.endLength = target.value.length;
              _this2.matchingString = el.productName.substr(_this2.startIndex, _this2.endLength);
              return el.productName.replace(_this2.matchingString, "<span>" + _this2.matchingString + "</span>");
            }
          });
        ...
        key: "highlight",
        value: function highlight(c) {
          this.content = c;
          this.searchMode = true;
          return this.content.replace(new RegExp(this.filter, "gi"), function (match) {
            console.log(match);
          });
        }
      }, {
  ...
  /***/
  function srcAppComponentsProductsProductsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsProductsProductsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductsComponent = /*#__PURE__*/function () {
      ...
      _createClass(ProductsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productService.getAllProducts().subscribe(function (res) {
            _this3.allProducts = JSON.parse(JSON.stringify(res));
          }, function (err) {
            return alert(err.error);
          });
          this.categoryService.getAllCategories().subscribe(function (res) {
            _this3.category = JSON.parse(JSON.stringify(res));
          });

          if (JSON.parse(localStorage.getItem("currentCart")).length > 0) {
            var _this$cartArr2;

            (_this$cartArr2 = this.cartArr).push.apply(_this$cartArr2, _toConsumableArray(JSON.parse(localStorage.getItem("currentCart"))));
          }
        }
      }, {
        key: "productsByCategory",
        ...
        value: function deleteProduct(product) {
          var id = product._id;
          var index = this.cartArr.findIndex(function (element) {
    ...
    ProductsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      "./src/app/components/products/products.component.css"))["default"]]
    })], ProductsComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsReceiptReceiptComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsReceiptReceiptComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ngx_filesaver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ngx-filesaver */
    "./node_modules/ngx-filesaver/fesm2015/ngx-filesaver.js");
    /* harmony import */
    ...
    var ReceiptComponent = /*#__PURE__*/function () {
      function ReceiptComponent(_FileSaverService, router) {
      ...
      _createClass(ReceiptComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.receipt = this.text.map(function (p) {
            return {
        ...
        key: "onDown",
        value: function onDown(type) {
          console.log(this.receipt);
          console.log(this.receipt2);
          var fileName = "receipt.".concat(type);

          var fileType = this._FileSaverService.genType(fileName);

          var txtBlob = new Blob([this.receipt2], {
            type: fileType
          });
    ...
    ReceiptComponent.ctorParameters = function () {
      return [{
    ...
    ReceiptComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-receipt',
      providers: [ngx_filesaver__WEBPACK_IMPORTED_MODULE_2__["FileSaverService"]],
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./receipt.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/receipt/receipt.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./receipt.component.css */
      "./src/app/components/receipt/receipt.component.css"))["default"]]
    })], ReceiptComponent);
    /***/
  },
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      ...
      _createClass(RegisterComponent, [{
        ...
        key: "onSubmit",
        value: function onSubmit(registerFormValue) {
          var _this4 = this;
          ...
          var identityObj = {
            "identity": registerFormValue.value.identity
          };
          this.userService.checkIdentity(identityObj).subscribe(function (res) {
            _this4.resIdentity = true;
          }, // If already exist
          function (err) {
            if (err.status === 403) {
              _this4.resIdentity = false;

              _this4.f.identity.setErrors({
                identityExist: true
              });
            } else {
              alert(err.message);
            ...
            if (registerFormValue.value.password !== registerFormValue.value.confirmPassword) {
              _this4.f.confirmPassword.setErrors({
                confirmErr: true
              });
            ...
            _this4.allFormDetails = registerFormValue.value;
            _this4.registerForm2 = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]().group({
  ...
  function srcAppHighlightPipeTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HighlightPipe = /*#__PURE__*/function () {
      ...
      _createClass(HighlightPipe, [{
        key: "transform",
        value: function transform(text, _ref) {
          var _ref2 = _slicedToArray(_ref, 1),
              search = _ref2[0];

          search = 'a';
          return search ? text.replace(new RegExp(search, 'gi'), function (match) {
    ...
    HighlightPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'highlight'
    })], HighlightPipe);
    /***/
  },
  ...
  function srcAppServicesUsersServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UsersService = /*#__PURE__*/function () {
      ...
      _createClass(UsersService, [{
        key: "postLoggedInUser",
        value: function postLoggedInUser(credentials) {
          return this.http.post("http://localhost:3000/api/auth/login", credentials);
        }
      }, {
        key: "registerUser",
        value: function registerUser(userDetails) {
          return this.http.post("http://localhost:3000/api/auth/register", userDetails);
        }
      }, {
        key: "checkIdentity",
        value: function checkIdentity(identity) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\תכנות\קורס עידן\shopping online\client\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
